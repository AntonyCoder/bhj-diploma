...
class TransactionsPage {
  ...
  registerEvents() {
    ...
    this.element.addEventListener('click', (event) => {
      ...
      if (btnRemoveTransaction) {
        const transactionId = btnRemoveTransaction.dataset.id;
  ...
  formatDate(date) {
    ...
    const formattedDate = new Intl.DateTimeFormat('ru-RU', optionsDate).format(currentDate);
    const formattedTime = new Intl.DateTimeFormat('ru-RU', optionsTime).format(currentDate);
